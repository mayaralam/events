      ...
      <div className="grid md:grid-cols-2 grid-cols-1 ">
        ...
        >
          <Form className="container mx-auto flex flex-col gap-4 justify-center items-center mt-20">
            ...
            <button
              type="submit"
              className="w-[50%] bg-purple-400 text-white rounded-lg px-2 py-1 mt-4 font-bold cursor-pointer font-sans"
            >
              Sign In
            </button>
            <div className="flex gap-2">
              ...
              <a href="/register" className="text-purple-600 dark:text-purple-400 font-light">
                Create one
              </a>
            </div>
          </Form>
